...
private:
    ...
    Pizzeria venezia_{"Venezia - real Italian pizza", {new Funghi{100.0}}, time};
    Pizzeria bravo_{"Bravo - good and cheap pizza", {new Margherita{80.0}}, time};
    Pizzeria grindtorp_{"Grindtorp pizzeria - local pizza", {new Margherita{90.0}, new Funghi{110.0}}, time};
};
